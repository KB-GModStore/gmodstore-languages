...
RCD.Language["ru"] = {
	...
	["allowed"] = "ДОСТУПНЫЕ",
	["cantCustomizeVehicle"] = "Вы не можете кастомизировать это авто \n приносим извинения за причиненные неудобства",
	...
	["customizeVehicleText"] = "Вы кастомизировали своё авто за %s",
	...
	["customizePrice"] = "У вас недостаточно денег, чтобы кастомизировать этот автомобиль",
