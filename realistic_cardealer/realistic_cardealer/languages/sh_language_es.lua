...
RCD.Language["es"] = {
	...
	["removeVehicleEverytime"] = "Borrar definitivamente los vehículos destruidos en cualquier estado",
	...
	["timeToStoleNewVehicle"] = "Tiempo para esperar antes de robar un nuevo vehículo",
	["notifyToStoleNewVehicle"] = "Necesitas esperar %s antes de robar un nuevo vehículo",
	["vehicleDestroyed"] = "No puedes realizar esta acción porque el vehículo está destruido",
	["cantReturnVehicleDestroyed"] = "No se puede devolver el vehículo cuando está destruido",
	["removeVehicleStolen"] = "Elimina permanentemente los vehículos robados si el jugador no tiene seguro",
	["noLoadFuel"] = "No guarde el combustible de los vehículos",
	["scale"] = "Escala del modelo",
	["searchVehicle"] = "Buscar un vehículo",
	["searchBarActivate"] = "Activar la barra de búsqueda para encontrar vehículos",
	["disableLockVehicle"] = "Deshabilitar el bloqueo automático de este vehículo",
	["garageNoShop"] = "Cuando desactives el garaje en el npc no verás los vehículos comprables",
	["shopNoGarage"] = "Cuando deshabilites la tienda en el npc no verás vehículos en propiedad",
	["carDealerNotConfigured"] = "No hay vehículos disponibles en el Car-Dealer",
	["defaultNitro"] = "Nitro por defecto",
	["none"] = "Ninguno",
	["descAddValue"] = "Agregar un valor a la lista",
	["addValue"] = "AGREGAR VALOR",
	["insertValue"] = "Insertar valor",
	["vehiclesWithoutEngine"] = "Vehículos sin motor",
	["vehiclesWithoutBelt"] = "Vehículos sin cinturón de seguridad",
}
