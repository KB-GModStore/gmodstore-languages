...
RCD.Language["fr"] = {
	...
	["removeVehicleEverytime"] = "Supprimer définitivement les véhicules détruits dans n'importe quelle condition",
	...
	["disableLockVehicle"] = "Désactiver le vérouillage automatique de ce vehicule",
	["garageNoShop"] = "Lorsque vous désactivez le garage sur le pnc, vous ne verrez pas les véhicules achetables",
	["shopNoGarage"] = "Lorsque vous désactivez le magasin sur le pnc, vous ne verrez pas les véhicules possédés",
	["carDealerNotConfigured"] = "Il n'y a pas de véhicule disponible dans le Car-Dealer",
	["defaultNitro"] = "Nitro de base",
	["none"] = "Aucun",
	["descAddValue"] = "Ajouter une valeur à la liste",
	["addValue"] = "Ajouter la valeur",
	["insertValue"] = "Insérer la valeur",
	["vehiclesWithoutEngine"] = "Véhicules sans moteur",
	["vehiclesWithoutBelt"] = "Véhicules sans ceinture de sécurité",
}
