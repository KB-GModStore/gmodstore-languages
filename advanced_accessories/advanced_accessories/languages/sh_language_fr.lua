...
AAS.Language["fr"] = {
    ...
    ["customCharacter"] = "Personnaliser votre personnage",
    ["adminDashboard"] = "PANNEAU D'ADMINISTRATION",
    ["welcomeText"] = "BIENVENUE, QUE SOUHAITEZ VOUS ACHETER ?",
    ["position"] = "POSITION",
    ["rotation"] = "ROTATION",
    ["scale"] = "TAILLE",
    ...
    ["exploitArmory"] = "Vous êtes trop éloigné de l'armoire pour faire ceci !",
    ["exploitNpc"] = "Vous êtes trop éloigné du PNJ pour faire ceci !",
    ...
    ["deequipedItem"] = "Vous venez de déséquiper l'accessoire !",
    ...
    ["iconPos"] = "Modifier la position de l'icône",
    ["iconFov"] = "Modifier le FOV de l'icône",
    ...
    ["titlePolishBeret"] = "Béret militaire",
    ["titlePolishBeret2"] = "Béret militaire",
    ["titlePolishBeret3"] = "Béret militaire",
    ...
    ["descBeret"] = "Wow, ça vous va bien",
    ["descBandMask"] = "Un masque pour le meilleur des crimes",
    ["descPinguin"] = "Un masque de pingouin pour vous glisser parmis vos congénères",
    ["descMummyMask"] = "Vous êtes désormais un ami d'Anubis",
    ...
    ["descMaskDoctor"] = "Jouer à docteur maboul ce n'est pas votre genre visiblement",
    ...
    ["descBeerHat"] = "Pour boire une bière sans le moindre effort. Fainéant !",
    ...
    ["descCatHat"] = "Pour avoir l'ouïe d'un chat",
    ...
    ["descCatsEars"] = "Avoir l'ouïe d'un chat ? Ça doit être cool nan ?",
    ...
    ["descSnowGoggles"] = "Ne pas avoir de neige dans les yeux ça doit sûrement être bien",
    ["descCap3"] = "Une casquette de bonne qualité",
    ["descHat"] = "Un chapeau noir de luxe",
    ["descGlasses6"] = "Une paire de lunettes luxueuse",
    ["descCap4"] = "Une casquette assez banale",
    ["descDrinkCap"] = "Afin de boire une binouze entre amis sans le moindre effort",
    ["descStarGlasses"] = "Si vous rêvez de devenir une star",
    ["descCatEars"] = "De bien belles oreilles de chat",
    ...
    ["descMonkeyMask2"] = "Il paraît qu'en le mettant vous ressemblerez à nos ancètres",
    ["descBearMask"] = "Un simple masque d'ours effrayant",
    ["descPigMask"] = "Attention! on pourrait vous confondre avec un cochon échappé de la porcherie",
    ["descPolishBeret"] = "Un beau béret militaire",
    ["descPolishBeret2"] = "Un beau béret militaire",
    ["descPolishBeret3"] = "Un beau béret militaire",
